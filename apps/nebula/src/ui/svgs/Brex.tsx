...
export default function Brex({ ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      version="1.1"
      id="layer"
  ...
  `}</style>
      <path
        className="st0"
        d="M427.9,274.7c-10.6,0-18.9,3.8-26.5,11.7v-9.9h-20.9v97.1H403v-56.3c0-12.9,7.7-21,19.3-21c2.1,0,4,0.3,5.3,0.5
